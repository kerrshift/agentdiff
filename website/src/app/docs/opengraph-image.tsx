...
/**
 * Section-level social card for /docs itself. Also claims the
 * /docs/opengraph-image path explicitly so it never falls through to the
 * [slug] route (which would otherwise try to render a guide literally
 * named "opengraph-image").
 */
    ...
    (
      ...
      >
        ...
        >
          ...
          <span>{`agentdiff.lostmartian.in/docs`}</span>
        </div>
      </div>
    ),
    size,
