    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ fontSize: 20, color: "#a1a1aa", border: "1px solid #e4e4e7", borderRadius: 999, padding: "2px 14px" }}>quickstart</div>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", color: "#a1a1aa", fontSize: 22 }}>
          ...
          <span>agentdiff.lostmartian.in/quickstart</span>
        </div>
      </div>
    ),
    size,
